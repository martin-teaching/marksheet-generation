...
def Question1( student_submission ):
    ...
    mustContainCorrectProperties = [ "Mac", "Key" ];
    ...
    with open("Assignments/" + assignment_name + "/Overview/overview.csv") as overview:
        ...
        for line in overviewLines:
                ...
                while True:
                  ...
                  if line != '':
                    ...
                    if "error" in line:
                        ...
                        question = Question("Question1", "Ask the student to download their code from KEATS. Give the student a mark out of 16 (code did not compile), based upon the Marking Guidelines.");

                        question.addMaxScore(16);
            ...
            if ( numberOfCorrectPropertiesFound > 0 & ( numberOfCorrectPropertiesFound >= len(mustContainCorrectProperties) ) ):
                ...
                question = Question("Question1", "Ask the student to download their code from KEATS. Give the student a mark out of 28, based upon the Marking Guidelines.");
    
                question.addMaxScore(28);
    
                student_submission.addQuestion(question);
                
            else:
                
                question = Question("Question1", "Ask the student to download their code from KEATS. Give the student a mark out of 27 (did not reference correct mac address or key), based upon the Marking Guidelines.");
    
                question.addMaxScore(27);
                
                question.setCapped("Did not reference correct mac address or key");
...
def Question2( student_submission ):
    ...
    question = Question("Question2", "When you asked the student to explain their handshake process to you, how confident and clear were they?");
